...
- when auto-update is enabled, `cronn` can start even if the crontab file doesn't exist, is empty, or has no jobs - it will begin with zero jobs and automatically load them when the file is created or populated.
